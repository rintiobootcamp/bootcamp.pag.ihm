angular.module('pag-site')
  .controller("WidgetSondageCtrl", function ($scope,$q, ModelSecteur, ModelPilier, ModelAxe, ModelProjet, ModelSondage, $stateParams, cookieModel, toaster) {
    console.log('Controller lauch');
