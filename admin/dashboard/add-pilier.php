          ...
          <form class="col s12">
            <div class="row">
              ...
              <div class="input-field col s12 m8">
                ...
                <label for="name"> Nom du pilier</label>
              </div>
              <div class="input-field col s12 m4">
                <input id="nbAxe" type="text" class="validate">
                <label for="nbAxe"> Nombre d'axe</label>
              </div>
              <div class="input-field col s12">
                <textarea id="textarea1" class="materialize-textarea"></textarea>
                <label for="textarea1">Description du pilier</label>
              </div>
            </div>
            <div class="row">
